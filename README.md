...
4. Delete the Readme.md and the .github folder since you won't be needing them.
5. Start the bot with a daemon process like [PM2](https://pm2.keymetrics.io/)!

If you need more help look at the [wiki](https://github.com/LebryantJohnson/ultimatebot/wiki) or dm me on Discord for support.
